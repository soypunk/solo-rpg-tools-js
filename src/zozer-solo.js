  ...
  class ZozerSolo{
   ...
   fast_space_combat(pilot_skill=0) {
      ...
      if (escapeAttack.total >= 10) {
         ...
         var avoidDamage = roller.roll(`2d6${randoDM}`);
   ...
   scout_planetoid_belt_targets() {
    ...
    scouts_survey_problems() {
      var value_table = {
         ...
         43: "The environment holds some real dangers that could affect the PCs. (Survival) If failed, a PC is injured at the survey site, or falls ill. (Medicine)",
         44: "The environment holds some real dangers that could affect the PCs. (Survival) If failed, a PC is injured at the survey site, or falls ill. (Medicine)",
         ...
         51: "Wildlife poses a deadly hazard. (Combat) If failed, a PC is injured at the survey site, or falls ill. (Medicine)",
         52: "Wildlife poses a deadly hazard. (Combat) If failed, a PC is injured at the survey site, or falls ill. (Medicine)",
